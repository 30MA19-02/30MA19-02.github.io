import { add, create, MathType, subtract, equalDependencies, largerDependencies, i } from 'mathjs';

import { Matrix } from './matrix';

const { larger: larger_, equal: equal_ } = create({ largerDependencies, equalDependencies }, { epsilon: 1e-12 });
